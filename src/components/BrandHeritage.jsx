...
export default function BrandHeritage() {
  return (
    <section className="py-space-xl md:py-28 bg-surface-container-low w-full relative" id="our-heritage">
      <div className="max-w-7xl mx-auto px-gutter grid grid-cols-1 lg:grid-cols-12 gap-gutter items-center">
        {/* Storytelling Left */}
        <div className="lg:col-span-6 flex flex-col gap-space-md">
          ...
          <h2 className="font-headline-lg text-headline-lg md:text-display-hero-mobile text-primary leading-tight">
            A Legacy of Living Terroir &amp; Master Craftsmanship
          </h2>

          <span className="font-headline-sm text-headline-sm text-secondary italic -mt-2">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-space-md mt-space-sm pt-space-md">
            <div className="bg-surface p-space-md rounded-lg shadow-sm border border-outline-variant/30">
              <div className="font-headline-sm text-headline-sm text-secondary font-bold">100+</div>
              <div className="font-label-caps text-label-caps text-primary uppercase mt-1 text-[11px]">Years of Tradition</div>
              <div className="font-body-sm text-body-sm text-on-surface-variant mt-1">Preserved artisanal orthodox roller methods.</div>
            </div>

            <div className="bg-surface p-space-md rounded-lg shadow-sm border border-outline-variant/30">
              <div className="font-headline-sm text-headline-sm text-secondary font-bold">0%</div>
              <div className="font-label-caps text-label-caps text-primary uppercase mt-1 text-[11px]">Middlemen</div>
              <div className="font-body-sm text-body-sm text-on-surface-variant mt-1">Estate direct to cup in fresh nitrogen sealed caddies.</div>
            </div>

            <div className="bg-surface p-space-md rounded-lg shadow-sm border border-outline-variant/30">
              <div className="font-headline-sm text-headline-sm text-secondary font-bold">Top 1%</div>
              <div className="font-label-caps text-label-caps text-primary uppercase mt-1 text-[11px]">Estate Plucking</div>
              <div className="font-body-sm text-body-sm text-on-surface-variant mt-1">Only the pristine terminal bud and two tender leaves.</div>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-6 relative flex flex-col gap-space-md">
          <div className="relative rounded-2xl overflow-hidden shadow-2xl">
            ...
            />
            <div className="absolute bottom-0 inset-x-0 p-space-md bg-gradient-to-t from-primary/95 via-primary/60 to-transparent text-on-primary">
          ...
          <div className="grid grid-cols-2 gap-space-md">
            <div className="rounded-xl overflow-hidden shadow-md bg-surface border border-outline-variant/20">
              <img
              ...
              <div className="p-space-sm">
                <span className="font-label-caps text-label-caps text-primary block text-xs font-bold">Master Sommelier Cupping</span>
                <span className="font-body-sm text-label-sm text-on-surface-variant">Every batch tested for 28 aroma notes.</span>
              </div>
            </div>
            ...
            <div className="rounded-xl overflow-hidden shadow-md bg-surface border border-outline-variant/20">
              ...
              />
              <div className="p-space-sm">
                <span className="font-label-caps text-label-caps text-primary block text-xs font-bold">Orthodox Gentle Rolling</span>
                <span className="font-body-sm text-label-sm text-on-surface-variant">Zero CTC crush-tear-curl pulverization.</span>
              </div>
            </div>
          </div>
        </div>
