...
export const TEA_QUIZ_QUESTIONS = [
  {
    id: "timeOfDay",
    question: "When do you plan to enjoy your Indian tea ritual?",
    options: [
      { label: "Dawn Awakening (Bold, energetic wake-up)", value: "morning", icon: "Sun" },
      { label: "Midday Focus & Mindful Work (Smooth & balanced)", value: "midday", icon: "Zap" },
      { label: "Twilight Unwind & Digestion (Delicate & soothing)", value: "evening", icon: "Moon" }
    ]
  },
  {
    id: "caffeinePref",
    question: "What is your preferred caffeine strength?",
    options: [
      { label: "High Kick (Bold Assam & Spiced Chai wake-up)", value: "High", icon: "Flame" },
      { label: "Refined Balanced Lift (Darjeeling, Nilgiri & Meghalaya)", value: "Medium", icon: "Sparkles" },
      { label: "Gentle & Mild (Silver Needle White & Saffron Kahwa)", value: "Low", icon: "ShieldCheck" }
    ]
  },
  {
    id: "flavorNotes",
    question: "Which iconic Indian flavor profile calls to you?",
    options: [
      { label: "Bold Malty Depth (Assam Golden Tips & CTC)", value: "malty", icon: "Coffee" },
      { label: "Ethereal Muscatel & Champagne (Darjeeling First Flush)", value: "muscatel", icon: "Flower" },
      { label: "Crisp Blue Mountain Frost & Floral (Nilgiri)", value: "floral", icon: "Leaf" },
      { label: "Stone-Fruit Cloud Forest Nectar (Meghalaya Oolong)", value: "stonefruit", icon: "Heart" },
      { label: "Warming Authentic Spices (Imperial Masala Chai & Saffron)", value: "spiced", icon: "Flame" }
    ]
  }
];

export const BLENDER_BASES = [
  { id: "assam", name: "Assam Estate Orthodox", caffeine: "High", type: "Black", color: "#b45309" },
  { id: "darjeeling", name: "Darjeeling First Flush", caffeine: "Medium", type: "Champagne Black", color: "#d97706" },
  { id: "nilgiri", name: "Nilgiri Frost Leaf", caffeine: "Medium", type: "Aromatic Black", color: "#854d0e" },
  { id: "meghalaya", name: "Meghalaya Cloud Oolong", caffeine: "Medium", type: "Semi-Oolong", color: "#ca8a04" },
  { id: "kashmiri", name: "Kashmiri Highland Green", caffeine: "Low", type: "Green", color: "#65a30d" }
];

export const BLENDER_BOTANICALS = [
  { id: "himalayan-rose", name: "Himalayan Damask Rose Petals", note: "Floral", color: "#f43f5e" },
  { id: "nilgiri-jasmine", name: "Nilgiri Night Jasmine Buds", note: "Aromatic Floral", color: "#f0fdf4" },
  { id: "tulsi", name: "Sacred Holy Basil (Rama Tulsi)", note: "Herbal Adaptogen", color: "#22c55e" },
  { id: "khasi-lemongrass", name: "Khasi Highland Lemongrass", note: "Citrus Refresh", color: "#eab308" },
  { id: "marigold", name: "Alpine Marigold Petals", note: "Sunny Glow", color: "#f97316" }
];

export const BLENDER_SPICES = [
  { id: "cardamom", name: "Wayanad Green Cardamom", intensity: 3 },
  { id: "ginger", name: "Sun-Dried Ginger Root (Sonth)", intensity: 4 },
  { id: "cinnamon", name: "Kerala Rolled Cinnamon Bark", intensity: 3 },
  { id: "clove", name: "Zanzibar/Nilgiri Aromatic Cloves", intensity: 4 },
  { id: "saffron", name: "Pampore Kashmiri Saffron Threads", intensity: 5 }
];
